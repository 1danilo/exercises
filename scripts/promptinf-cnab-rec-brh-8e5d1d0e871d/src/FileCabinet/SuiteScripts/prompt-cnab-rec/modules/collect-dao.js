...
define(['N/record', 'N/search'],
  function (record, search) {
     ...
     * @type {string}
     */
    const RECORD_TYPE = 'customrecord_ps_collect'
...
// A função abaixo não será necessária na Cobrança poruqe o status é um texto em vez de código
    // /**
    ...
    //   return search.create({
    //     type: 'customrecord_ps_collect_status',
    //     filters: [{
